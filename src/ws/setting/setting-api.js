...
router.post('/wifi/apmode', function(req,res){
    console.log(req.body);
    res.json({msg: 'success'})
    // { ssid: 'SmartGrobot-A', password: 'raspberry' }
    wifi.ap.StartAP(req.body.ssid, req.body.password);
});
router.post('/wifi/stamode', function(req,res){
    console.log(req.body);
    res.json({msg: 'success'})
    // { ssid: 'SmartGrobot-A', password: 'raspberry' }
    wifi.station.StartWifi(req.body.ssid, req.body.password);
});
